...
const Courses: React.FC = () => {
    ...
    return <Box sx={{display: 'flex', justifyContent: 'center'}}><Paper
        sx={{height: {xs: '90vh', sm: '85vh', md: '80vh'}, width: {xs: '100%', md: '80%'}}}>
        ...
        >
            <Box sx={style}>
                <List>
                    {shownCourse.current && Object.entries(shownCourse.current as any).map(e => <ListItem
